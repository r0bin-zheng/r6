...
def scalar_dom_ea_dp(init_size, toolbox, mu, lambda_, max_evaluations,
                     category_size=300, rate=0.5, f_min=None, f_max=None, exp_path=None):
    ...
    # local_model = toolbox.init_local_model(archive)   # init local model
    ...
    while evaluations < max_evaluations:
        ...
        if global_flag:
            ...
            individual = toolbox.filter(offsprings, rep_individuals, nd_rep_individuals, None, s_model, category_size, evalTimes=evaluations)
        else:
            individual = toolbox.filter(offsprings, rep_individuals, nd_rep_individuals, p_model, None, category_size, evalTimes=evaluations)
        ...
        if individual is None:
            ...
            if none_time > max_none_time:
                ...
                print("rep_individuals", rep_individuals)
