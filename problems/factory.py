...
from pymoo.problems import get_problem as get_problem_
...
def get_problem_pymoo(name, *args, **kwargs):
    problem = get_problem_(name, *args, **kwargs)
    problem.name = name.lower()
    return problem
